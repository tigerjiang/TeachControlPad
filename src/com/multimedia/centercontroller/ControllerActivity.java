...
public class ControllerActivity extends Activity implements OnClickListener,
        OnItemSelectedListener, OnItemClickListener, IUpdateSeatNo {
    ...
    private TextView mDeviceStateView, mTimeView, mStudentStateView, mErrorMsgView,mVersionView;
    ...
    public boolean checkNetworkAvailable() {
        ...
        Toast.makeText(getApplicationContext(), "Network status: " + mIsInternetConnected,
		...
		public void handleMessage(Message msg) {
            ...
            if ("cmd".equals(message.getTpye())) {
                ...
                // line in
                    ...
                    if (message.isMe()) {
                        CommandManager.leaveGroup("");
                        mGroupAddr = GroupInfo.getGroupId("g" + message.getGroup());
			...
			try {
				...
				delayTime = Integer.parseInt(message.getParams());
			       }
			    } catch (Exception e) {
